      ...
      <div className="flex gap-2">
        {['ALL', 'PENDING', 'PLACED'].map(s => (
          <button
            key={s}
            onClick={() => setFilter(s)}
            className={`px-4 py-2 rounded-lg font-medium transition-all duration-200 active:scale-95 active:shadow-inner ${filter === s
              ? s === 'ALL'
          ...
          <div className="flex justify-between items-start">
            <div>
              <div className="flex items-center gap-2">
                ...
                <span className={`px-2 py-1 rounded text-xs font-semibold ${o.status === 'PENDING'
          ...
          <div className="flex gap-2 mt-3">
            ...
            <button
              ...
              onClick={async () => {
                ...
                const res = await fetch(`/api/supabaseProxy/orders?id=eq.${o.id}`, {
                  method: 'DELETE'
                })
                if (!res.ok) {
